...
alias gcloud='docker run --rm -ti -v $HOME/.config/gcloud:/root/.config/gcloud -v $HOME/.ssh/google_compute_engine:/root/.ssh/google_compute_engine -v $HOME/.ssh/google_compute_known_hosts:/root/.ssh/google_compute_known_hosts -v $HOME/.ssh/google_compute_engine.pub:/root/.ssh/google_compute_engine.pub google/cloud-sdk gcloud'
